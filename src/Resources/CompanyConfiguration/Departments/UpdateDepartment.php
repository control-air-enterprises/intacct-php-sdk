...
final readonly class UpdateDepartment
{
    ...
    {
        Assert::notBlank($name, 'The department name');
    ...
    public function withReportTitle(?string $reportTitle): self
    {
        return $this->with('reportTitle', $reportTitle);
    }
    ...
    public function withSupervisor(?ObjectReference $supervisor): self
    {
        return $this->with('supervisor', $supervisor?->toWriteArray());
    }
